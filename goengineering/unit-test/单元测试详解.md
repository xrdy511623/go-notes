...
```bash
go run ./goprincipleandpractise/unit-test/trap/loop-capture/
```
...
```bash
go run ./goprincipleandpractise/unit-test/trap/goroutine-leak/
```
...
```bash
go run ./goprincipleandpractise/unit-test/trap/test-pollution/
```
